        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="<?= base_url('sertifikat') ?>">Sertifikat</a></li>
        ...
        <div class="content-wrapper">
          <div class="main-panel">
            <div class="page-header">
              <h3 class="page-title"> table sertifikat </h3>
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <!-- <tr>
                          <td><?= $row->sertifikat_id ?></td>
                          <td><?= $row->participant_name ?></td>
                          <td><?= $row->event_name ?></td>
                          <td><?= $row->event_date ?></td>
                          <td><?= $row->sertifikat_text ?></td>
                          <td>
                            <a href="<?= base_url('Sertifikat/edit_sertifikat/' . $row->sertifikat_id);?>" class="btn btn-primary round btn-sm">edit<i data-feather="edit"></i></a>
                            <a href="<?= base_url('Sertifikat/hapus_sertifikat/' . $row->sertifikat_id); ?>" class="btn btn-danger round btn-sm">hapus<i data-feather="trash"></i></a>
                            </td>
                        </tr> -->
                        <?php
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" name="event_date" class="form-control" value="<?= $evn->Data_event ?>">
                      <?= form_error('data_event', '<div class="text-small text-danger">', '</div>'); ?>
                    </div>
                    <div class="form-group">
